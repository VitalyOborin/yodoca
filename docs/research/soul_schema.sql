...
-- Core state snapshot (single logical row)
...
-- Short-lived companion traces. These are written only for meaningful events,
-- not on every background tick.
...
-- Raw interaction facts used to derive availability and relationship metrics.
...
-- Daily aggregated observability surface.
